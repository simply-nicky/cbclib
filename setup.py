...
extensions += [Pybind11Extension("cbclib.src.fft_functions",
               ...
               Pybind11Extension("cbclib.src.geometry",
                                 ...
                                 define_macros = [('VERSION_INFO', __version__)],
                                 **extension_args),
               Pybind11Extension("cbclib.src.kd_tree",
                                 sources=["cbclib/src/kd_tree.cpp"],
                                 define_macros = [('VERSION_INFO', __version__)],
                                 **extension_args),
               Pybind11Extension("cbclib.src.image_proc",
                                 ...
                                 define_macros = [('VERSION_INFO', __version__)],
                                 **extension_args),
               Pybind11Extension("cbclib.src.label",
                                 sources=["cbclib/src/label.cpp"],
                                 define_macros = [('VERSION_INFO', __version__)],
                                 **extension_args),
               ...
               Pybind11Extension("cbclib.src.signal_proc",
                                 ...
                                 define_macros = [('VERSION_INFO', __version__)],
                                 **extension_args),
               Pybind11Extension("cbclib.src.streak_finder",
                                 sources=["cbclib/src/streak_finder.cpp"],
                                 define_macros = [('VERSION_INFO', __version__)],
                                 **extension_args)]
