'''
gen_best_LX_match.py is to generate the matching figures
...
if __name__=='__main__':
    ...
    for best_GA_res_file in best_GA_res_file_list:
        ...
        os.system('sbatch /home/lichufen/CCB_ind/best_LX_match.sh /home/lichufen/CCB_ind/scan_corrected_00135.h5  '+best_GA_res_file)
