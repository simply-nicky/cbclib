...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/gpfs/cfel/cxi/scratch/user/nivanov/.conda/envs/cbc/include/fftw3.h",
...
static char __pyx_doc_6cbclib_3bin_15data_processing_10median[] = "median(ndarray data: np.ndarray, ndarray mask: np.ndarray, int axis: cython.int = 0, unsigned int num_threads: cython.uint = 1) -> np.ndarray\nCalculate a median along the `axis`.\n\n    Parameters\n    ----------\n    data : numpy.ndarray\n        Intensity frames.\n    mask : numpy.ndarray\n        Bad pixel mask.\n    axis : int, optional\n        Array axis along which median values are calculated.\n    num_threads : int, optional\n        Number of threads.\n\n    Returns\n    -------\n    wfield : numpy.ndarray\n        Whitefield.\n    ";
...
static PyArrayObject *__pyx_pw_6cbclib_3bin_15data_processing_11median(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mask)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("median", 0, 2, 4, 1); __PYX_ERR(0, 344, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("median", 0, 2, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 344, __pyx_L3_error)
  __pyx_L3_error:;
