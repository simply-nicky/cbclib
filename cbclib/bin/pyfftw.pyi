...
class FFTW:
    ...
    :meth:`~cbclib.bin.FFTW.execute` method.

    The arrays can be updated by calling the
    :meth:`~cbclib.bin.FFTW.update_arrays` method.
    ...
    the result of the FFT. Unlike calling the :meth:`~cbclib.bin.FFTW.execute`
    ...
    See the documentation on the :meth:`~cbclib.bin.FFTW.__call__` method
    ...
    Args:
        ...
        direction : It describes what sort of transformation the object
            ...
            * `'FFTW_BACKWARD'`, which is the backward discrete Fourier
            ...
            transforms, then :class:`cbclib.bin.FFTW` supports four different
            ...
            * `'FFTW_RODFT01'`.
            ...
            :class:`cbclib.bin.FFTW` uses the same naming convention for these
            ...
            .. code-block:: python
                ...
                a = cbclib.bin.empty_aligned((128,128,128))
                b = cbclib.bin.empty_aligned((128,128,128))
                directions = ['FFTW_REDFT00', 'FFTW_RODFT11']
                transform = cbclib.bin.FFTW(a, b, axes=(0, 2), direction=directions)
    ...
    .. admonition:: Schemes
        ...
        * For a Real transform in the Backwards direction, both the following
        ...
        :func:`~cbclib.bin.byte_align` and
        :func:`~cbclib.bin.empty_aligned` are two methods
        included with this module for producing aligned arrays.

        The optimum alignment for the running platform is provided
        by :data:`cbclib.bin.simd_alignment`, though a different alignment
        ...
        transform (which :class:`cbclib.bin.FFTW` will handle for you when
        accessed through :meth:`~cbclib.bin.FFTW.__call__`).
    """
    ...
    def __call__(self, input_array: Optional[np.ndarray]=None,
        ...
        calls :meth:`~cbclib.bin.FFTW.execute`, before optionally normalising
        ...
        calling :meth:`~cbclib.bin.FFTW.execute`).
        ...
        Notes:
            ...
            then passed as arguments to :meth:`~cbclib.bin.FFTW.update_arrays`,
            after which :meth:`~cbclib.bin.FFTW.execute` is called, and then
            ...
            :meth:`~cbclib.bin.FFTW.update_arrays` are enforced.
